...
public class CloudActivity extends AppCompatActivity {
    ...
    private static final String CUSTOMER_SPECIFIC_ENDPOINT = "a2zgnpn7ya2td1.iot.us-east-2.amazonaws.com";
    // Cognito pool ID. For this app, pool needs to be unauthenticated pool with
    // AWS IoT permissions.
    private static final String COGNITO_POOL_ID = "us-east-2:be3fd889-5b08-447a-afa7-4fc749eed242";
    // Name of the AWS IoT policy to attach to a newly created certificate
    private static final String AWS_IOT_POLICY_NAME = "GesturePolicy";
